...
import com.woowacourse.kkogkkog.coupon2.application.dto.CouponHistoryResponse;
...
class CouponServiceTest {
    ...
    class save {
        ...
        void success_couponSave() {
            ...
            Long couponId = response.get(0).getCouponId();
